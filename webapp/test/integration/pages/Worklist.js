					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success: function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("scheme_agency_id"),
								name: oBindingContext.getProperty("AcademicTitleCode")
							};
						}
					}));
				},
						...
						success: function (oTable) {
							return this.waitFor({
								...
								success: function (aItems) {
									var aAllEntities = this.getEntitySet("AcademicTitleCollection");
